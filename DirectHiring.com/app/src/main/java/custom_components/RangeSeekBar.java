...
import utilities.others.BitmapUtil;
import utilities.others.PixelUtil;

public class RangeSeekBar<T extends Number> extends ImageView {
    public static final int ACTIVE_COLOR = Color.parseColor("#303F9F");
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.mipmap.seekbarthumb;
        int thumbPressed = R.mipmap.seekbarthumb;
        int thumbDisabled = R.mipmap.seekbarthumb;
        ...
        if (attrs == null) {
            ...
            mTextAboveThumbsColor = Color.parseColor("#3F51B5");
            ...
            try {
                ...
                mTextAboveThumbsColor = a.getColor(R.styleable.RangeSeekBar_textAboveThumbsColor, Color.parseColor("#3F51B5"));
